...
describe('public home page', () => {
  it('shows the product pitch, Google sign-in and explanatory sections', () => {
    ...
    assert.match(landing, /home-landing-preview/);
    assert.match(landing, /home-landing-grid/);
    assert.match(landing, /home\.featureHistory/);
    assert.match(landing, /home\.featureShare/);
    assert.match(landing, /home\.featureNotifications/);
    assert.match(landing, /home\.previewDish1/);
